document.addEventListener('DOMContentLoaded', function(){
    ...
    function validar(e){
        ...
        if(e.target.id === 'cc' && !validarEmail(e.target.value)){
            mostrarAlerta('El destinarario no es valido', e.target.parentElement);
            comprobarEmail();
            return;
        }
         ...
         //Asignar los valores 
         //toLowerCase()  que todo este en minusculas 
    ...
    function validarEmail(email){
        //Patron regular para validar una expresion regular 
